...
%define kmod_git_hash		96659bee1597c82a3e18baff87f86f52c3451f44
%define kmod_kernel_version	3.10.0-327.el7
%define kernel_version		3.10.0-327.el7
%define kmod_kbuild_dir		drivers/net/ethernet/sfc
...
%changelog
* Tue Sep 13 2016 Petr Oros <poros@redhat.com> 4.0 1
- sfc DUP module
- Resolves: #1375889
